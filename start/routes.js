...
Route.post(
    "/password/email",
    "Auth/PasswordResetController.prepareResetLinkEmail"
);
...
Route.group(() => {
    ...
    Route.resource("supplier", "SupplierController")
        .apiOnly()
        .validator(new Map([[["supplier.store"], ["StoreSupplier"]]]));
    ...
    Route.get(
        "paid_bills_by_category",
        "BillToPayController.getPaidBillByCategory"
    );
